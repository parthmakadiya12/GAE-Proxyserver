...
__author__ = "Parth Makadiya(parthmakadiya12@gmail.com)"
#Helped by Several Friends .Thanks All Friends for Help
...
class HomeHandler(BaseHandler):
  def get(self):
    ...
    if latest_urls is None:
      ...
      # This is actually saved in the Datastore.
...
class MirrorHandler(BaseHandler):
  def get(self, base_url):
    ...
    logging.debug('Base_url = "%s", url = "%s"', base_url, self.request.url)
       ...
       = self.get_relative_url()[1:]  # remove leading /
